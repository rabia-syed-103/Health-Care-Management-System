...
-- Convert all INT primary keys to auto-incrementing SERIAL
CREATE SEQUENCE IF NOT EXISTS admin_id_seq;
ALTER TABLE admin ALTER COLUMN id SET DEFAULT nextval('admin_id_seq');
SELECT setval('admin_id_seq', COALESCE((SELECT MAX(id) FROM admin), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS doctor_id_seq;
ALTER TABLE doctor ALTER COLUMN id SET DEFAULT nextval('doctor_id_seq');
SELECT setval('doctor_id_seq', COALESCE((SELECT MAX(id) FROM doctor), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS receptionist_id_seq;
ALTER TABLE receptionist ALTER COLUMN id SET DEFAULT nextval('receptionist_id_seq');
SELECT setval('receptionist_id_seq', COALESCE((SELECT MAX(id) FROM receptionist), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS pharmacist_id_seq;
ALTER TABLE pharmacist ALTER COLUMN id SET DEFAULT nextval('pharmacist_id_seq');
SELECT setval('pharmacist_id_seq', COALESCE((SELECT MAX(id) FROM pharmacist), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS blood_manager_id_seq;
ALTER TABLE blood_manager ALTER COLUMN id SET DEFAULT nextval('blood_manager_id_seq');
SELECT setval('blood_manager_id_seq', COALESCE((SELECT MAX(id) FROM blood_manager), 0) + 1, false);
...
SELECT setval('medicine_id_seq', COALESCE((SELECT MAX(id) FROM medicine), 0) + 1, false);
...
SELECT setval('appointment_id_seq', COALESCE((SELECT MAX(id) FROM appointment), 0) + 1, false);
...
SELECT setval('prescription_id_seq', COALESCE((SELECT MAX(id) FROM prescription), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS prescription_medicine_id_seq;
ALTER TABLE prescription_medicine ALTER COLUMN id SET DEFAULT nextval('prescription_medicine_id_seq');
SELECT setval('prescription_medicine_id_seq', COALESCE((SELECT MAX(id) FROM prescription_medicine), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS dispensing_id_seq;
ALTER TABLE dispensing ALTER COLUMN id SET DEFAULT nextval('dispensing_id_seq');
SELECT setval('dispensing_id_seq', COALESCE((SELECT MAX(id) FROM dispensing), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS ot_id_seq;
ALTER TABLE ot ALTER COLUMN id SET DEFAULT nextval('ot_id_seq');
SELECT setval('ot_id_seq', COALESCE((SELECT MAX(id) FROM ot), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS er_patient_id_seq;
ALTER TABLE er_patient ALTER COLUMN id SET DEFAULT nextval('er_patient_id_seq');
SELECT setval('er_patient_id_seq', COALESCE((SELECT MAX(id) FROM er_patient), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS er_patient_entry_id_seq;
ALTER TABLE er_patient_entry ALTER COLUMN id SET DEFAULT nextval('er_patient_entry_id_seq');
SELECT setval('er_patient_entry_id_seq', COALESCE((SELECT MAX(id) FROM er_patient_entry), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS blood_request_id_seq;
ALTER TABLE blood_request ALTER COLUMN id SET DEFAULT nextval('blood_request_id_seq');
SELECT setval('blood_request_id_seq', COALESCE((SELECT MAX(id) FROM blood_request), 0) + 1, false);

CREATE SEQUENCE IF NOT EXISTS donor_id_seq;
ALTER TABLE donor ALTER COLUMN id SET DEFAULT nextval('donor_id_seq');
SELECT setval('donor_id_seq', COALESCE((SELECT MAX(id) FROM donor), 0) + 1, false);
