...
INSERT INTO Admin (ID, Name, Email, P_No, Password) VALUES
(1, 'Super Admin',     'admin@hospital.pk',        '0300-0000001', ''),
(2, 'Ops Manager',     'ops.manager@hospital.pk',  '0300-0000002', ''),
(3, 'IT Administrator','it.admin@hospital.pk',     '0300-0000003', '');
...
INSERT INTO Doctor (ID, Name, Email, P_No, Specialization, Password) VALUES
...
SELECT SETVAL('doctor_id_seq', 12);


--  RECEPTIONIST 

INSERT INTO Receptionist (ID, Name, Email, P_No, Password) VALUES
...
SELECT SETVAL('receptionist_id_seq', 6);


--  PHARMACIST 

INSERT INTO Pharmacist (ID, Name, Email, P_No, Password) VALUES
...
SELECT SETVAL('pharmacist_id_seq', 6);


-- BLOOD_MANAGER

INSERT INTO Blood_Manager (ID, Name, Email, P_No, Password) VALUES
...
SELECT SETVAL('blood_manager_id_seq', 4);


-- PATIENT
INSERT INTO Patient (ID, Name, Email, B_Gr, P_No) VALUES
(1,  'Ali Hassan',        'ali.hassan@gmail.com',        'A+',  '0345-1111111'),
(2,  'Fatima Zahra',      'fatima.zahra@gmail.com',      'B+',  '0345-2222222'),
(3,  'Muhammad Usman',    'usman.m@gmail.com',           'O+',  '0345-3333333'),
(4,  'Zainab Mirza',      'zainab.mirza@gmail.com',      'AB+', '0345-4444444'),
(5,  'Hassan Riaz',       'hassan.riaz@gmail.com',       'A-',  '0345-5555555'),
(6,  'Mariam Aslam',      'mariam.aslam@gmail.com',      'B-',  '0345-6666666'),
(7,  'Saad Nawaz',        'saad.nawaz@gmail.com',        'O-',  '0345-7777777'),
(8,  'Hira Yousaf',       'hira.yousaf@gmail.com',       'A+',  '0345-8888888'),
(9,  'Junaid Bhatti',     'junaid.bhatti@gmail.com',     'B+',  '0345-9999999'),
(10, 'Sobia Anwar',       'sobia.anwar@gmail.com',       'O+',  '0345-1010101'),
(11, 'Adeel Farhan',      'adeel.farhan@gmail.com',      'AB-', '0345-1111112'),
(12, 'Raheela Pervaiz',   'raheela.pervaiz@gmail.com',   'A+',  '0345-1212121'),
(13, 'Kashif Mahmood',    'kashif.mahmood@gmail.com',    'B+',  '0345-1313131'),
(14, 'Iqra Siddiqui',     'iqra.siddiqui@gmail.com',     'O+',  '0345-1414141'),
(15, 'Naveed Sultan',     'naveed.sultan@gmail.com',     'A-',  '0345-1515151'),
(16, 'Amna Butt',         'amna.butt@gmail.com',         'B-',  '0345-1616161'),
(17, 'Fahad Rehman',      'fahad.rehman@gmail.com',      'O-',  '0345-1717171'),
(18, 'Sana Rashid',       'sana.rashid@gmail.com',       'AB+', '0345-1818181'),
(19, 'Umar Hayat',        'umar.hayat@gmail.com',        'A+',  '0345-1919191'),
(20, 'Nadia Waheed',      'nadia.waheed@gmail.com',      'B+',  '0345-2020202');

SELECT SETVAL('patient_id_seq', 20);
...
SELECT SETVAL('er_patient_id_seq', 12);
...
(15, 'Saira Batool',     '0312-1515151', 'saira.b@gmail.com',      'O+',  '2026-01-04');

SELECT SETVAL('donor_id_seq', 15);


--  BLOOD 

INSERT INTO Blood (ID, B_Gr, Collected_Date, Status, Expiry_Date, Unit, Donor_ID) VALUES
(1,  'A+',  '2025-11-01', 'reserved', '2026-05-01', 5,  1),
(2,  'B+',  '2025-11-03', 'available','2026-04-03', 6,  2),
(3,  'O+',  '2025-11-05', 'reserved', '2026-04-05', 8,  3),
(4,  'AB+', '2025-11-07', 'available','2026-04-07', 4,  4),
(5,  'A-',  '2025-11-09', 'reserved', '2026-05-09', 3,  5),
(6,  'B-',  '2025-11-11', 'available','2026-04-6', 7,  6),
(7,  'O-',  '2025-11-13', 'reserved', '2026-05-13', 8,  7),
(8,  'O+',  '2025-11-15', 'reserved', '2026-05-15', 6,  8),
(9,  'A+',  '2025-11-17', 'reserved', '2026-04-17', 4,  9),
(10, 'B+',  '2025-11-19', 'available','2026-05-19', 5,  10),
(11, 'AB-', '2025-11-21', 'available','2026-04-21', 3,  11),
(12, 'O-',  '2025-11-23', 'available','2026-05-23', 8,  12),
(13, 'A-',  '2025-11-25', 'available','2026-04-25', 4,  13),
(14, 'B-',  '2025-11-27', 'available','2026-05-27', 6,  14),
(15, 'O-',  '2025-11-29', 'available','2026-04-11', 9,  15),
(16, 'AB+', '2025-12-01', 'available','2026-05-11', 3,  NULL),
(17, 'O+',  '2025-12-03', 'available','2026-06-03', 7,  NULL),
(18, 'A+',  '2025-12-05', 'available','2026-04-14', 5,  NULL);

SELECT SETVAL('blood_id_seq', 18);


-- DONATION
INSERT INTO Donation (ID, Donor_ID, Manager_ID, Blood_ID, Donation_Date, Status) VALUES
(1,  1,  1, 1,  '2025-10-01', 'completed'),
(2,  2,  1, 2,  '2025-09-15', 'completed'),
(3,  3,  2, 3,  '2025-08-20', 'completed'),
(4,  4,  2, 4,  '2025-07-10', 'completed'),
(5,  5,  3, 5,  '2025-10-05', 'completed'),
(6,  6,  3, 6,  '2025-09-01', 'completed'),
(7,  7,  4, 7,  '2025-08-11', 'completed'),
(8,  8,  4, 8,  '2025-07-25', 'completed'),
(9,  9,  1, 9,  '2025-10-10', 'completed'),
(10, 10, 2, 10, '2025-09-20', 'completed'),
(11, 11, 3, 11, '2025-08-01', 'completed'),
(12, 12, 4, 12, '2025-07-15', 'completed'),
(13, 13, 1, 13, '2025-09-05', 'completed'),
(14, 14, 2, 14, '2025-10-15', 'completed'),
(15, 15, 3, 15, '2025-08-30', 'completed');
...
SELECT SETVAL('appointment_id_seq', 20);


--  MEDICINE 

INSERT INTO Medicine (ID, Batch_No, Name, Stock, Expiry_Date) VALUES
(1,  'BATCH-001', 'Paracetamol',        495, '2028-06-01'),
(2,  'BATCH-002', 'Amoxicillin',        299, '2027-03-15'),
(3,  'BATCH-003', 'Metformin',          397, '2028-08-20'),
(4,  'BATCH-004', 'Atorvastatin',       249, '2028-07-10'),
(5,  'BATCH-005', 'Omeprazole',         348, '2027-05-25'),
(6,  'BATCH-006', 'Ciprofloxacin',      198, '2027-04-30'),
(7,  'BATCH-007', 'Aspirin',            598, '2029-01-01'),
(8,  'BATCH-008', 'Ibuprofen',          449, '2028-09-15'),
(9,  'BATCH-009', 'Lisinopril',         179, '2027-06-20'),
(10, 'BATCH-010', 'Azithromycin',       148, '2027-02-28'),
(11, 'BATCH-011', 'Insulin Glargine',    99, '2027-12-01'),
(12, 'BATCH-012', 'Salbutamol',         219, '2028-10-10'),
(13, 'BATCH-013', 'Diazepam',            78, '2027-03-05'),
(14, 'BATCH-014', 'Ceftriaxone',        118, '2027-11-20'),
(15, 'BATCH-015', 'Dexamethasone',      158, '2028-01-15'),
(16, 'BATCH-016', 'Metronidazole',      199, '2027-08-10'),
...
SELECT SETVAL('medicine_id_seq', 20);
...
SELECT SETVAL('prescription_id_seq', 18);
...
SELECT SETVAL('prescription_medicine_id_seq', 30);
...
SELECT SETVAL('dispensing_id_seq', 18);
...
SELECT SETVAL('er_patient_entry_id_seq', 12);
...
SELECT SETVAL('blood_request_id_seq', 15);
...
SELECT table_name, records FROM (
    SELECT 'Admin'                         AS table_name, COUNT(*) AS records FROM Admin
